...
export default function Men() {
    ...
    async function getMen(categoty) {
    ...
    return <>
        ...
        {menClothing.length === 0 ? <div className="spin position-relative top-0 bottom-0 start-0 end-0 d-flex justify-content-center align-items-center">
            <i class="fa-solid fa-spinner fa-spin fa-3x"></i>
        </div> : <div className="container my-5">
            <div className="row">
                {menClothing.map((product, index) =>
                        ...
                        <div className="productCard bg-dark position-relative">
                            ...
                            <div className="content px-4 py-3">
                                ...
                                <p>
                                    ...
                                    <Link className='seeMore' to={`/productDetails/${product.id}`}>
                                        see more
                                    </Link>
                                </p>
